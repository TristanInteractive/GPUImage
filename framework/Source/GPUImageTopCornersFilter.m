#import "GPUImageTopCornersFilter.h"

#if TARGET_IPHONE_SIMULATOR || TARGET_OS_IPHONE
NSString *const kGPUImageTopCornersFragmentShaderString = SHADER_STRING
(
...
(
 ...
 void main()
 {
     ...
     if (textureCoordinate.y < vignetteCenter.y)
         gl_FragColor = vec4(mix(sourceImageColor.rgb, vignetteColor, percent), sourceImageColor.a);
     else
         gl_FragColor = sourceImageColor;
 }
...
@implementation GPUImageTopCornersFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kGPUImageTopCornersFragmentShaderString]))
    {
		return nil;
    }
